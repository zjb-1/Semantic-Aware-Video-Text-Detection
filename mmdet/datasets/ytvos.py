...
class YTVOSDataset(CustomDataset):
    ...
    def sample_ref(self, idx):
        ...
        for i in sample_range:
            ...
            # frame id is far
            if i != frame_id and ref_id in self.img_ids and abs(i - frame_id) <= self.sample_margin:
    ...
    def prepare_train_img(self, idx):
        ...
        if (vis):
            ...
            thickness = 1
            lineType = 8
            img_vis = mmcv.imrescale(img_vis, scale_factor)
            ref_img_vis = mmcv.imrescale(ref_img_vis, scale_factor)
            if self.with_crop:
                img_vis = img_vis[crop_top : crop_bottom, crop_left : crop_right, :]
                ref_img_vis = ref_img_vis[ref_crop_top : ref_crop_bottom, ref_crop_left : ref_crop_right, :]   
            ...
            mmcv.imwrite(img_vis, im_name_box)
            ...
            mmcv.imwrite(ref_img_vis, ref_name_box)
